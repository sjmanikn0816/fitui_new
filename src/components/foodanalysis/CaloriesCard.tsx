...
const CaloriesCard = ({ totalNutrition }) => {
  return (
    <LinearGradient colors={[ Colors.white,  Colors.white]} start={{ x: 0, y: 0 }} end={{ x: 1, y: 1 }} style={styles.card}>
...
const styles = StyleSheet.create({
  card: { marginHorizontal: 20, marginTop: 20, borderRadius: 16, padding: 20, alignItems: "center", shadowColor: "#FF6B6B", shadowOffset: { width: 0, height: 3 }, shadowOpacity: 0.15, shadowRadius: 8, elevation: 5 },
