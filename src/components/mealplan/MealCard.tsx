...
const styles = StyleSheet.create({
  ...
  info: { flex: 1 },
  mealType: { fontSize: 12, fontWeight: "700", color: "#6b7280", marginBottom: 2 },
  mealName: { fontSize: 16, fontWeight: "600", color: "#111827" },
  meta: { flexDirection: "row", alignItems: "center", marginTop: 6 },
  metaText: { fontSize: 12, color: "#6B7280" },
  separator: { marginHorizontal: 6, fontSize: 12, color: "#9ca3af" },
  calories: { flexDirection: "row", alignItems: "center", marginRight: 12 },
  calText: { fontSize: 14, fontWeight: "600", marginLeft: 4, color: "#374151" },
});
